...
Hello! Welcome to the bookdown of my STAT 454 Bayesian Statistics project!
...
<!--chapter:end:02_DataSource.Rmd-->

# Data Cleaning
jhgklja

<!--chapter:end:03_DataCleaning.Rmd-->
...
<!--chapter:end:04_Visualizations.Rmd-->
...
<!--chapter:end:05_OrderedLogisticRegression.Rmd-->
...
<!--chapter:end:09_FinalReflections.Rmd-->
